...
@section('content')
    {{-- 
        <body class="font-['Lexend']">
            ...
            <section class="flex flex-col items-center w-full font-light text-center text-zinc-700 max-md:max-w-full"
            ...
            <!-- Brand Story -->
            <section class=" text-xl font-normal leading-9  text-center text-zinc-700" style="margin-bottom: 6.25rem;">
            ...
            <!-- Brand Images -->
            <section class="flex flex-wrap justify-between items-center w-full gap-2.5 max-md:mt-10"
                style="margin-bottom: 100px;">
                <figure class="w-[420px] h-[460px] flex-shrink-0">
            ...
            <!-- Brand Philosophy -->
            <section
                class="flex flex-col pt-1.5 pr-20 pb-5  w-full text-xl font-normal leading-9 rounded-none text-zinc-700 max-md:pr-5 max-md:mt-10"
                style="margin-bottom:6.25rem;">
            ...
            <div class="flex justify-center" style="margin-bottom:6.25rem;">
                <section>
                    <figure class="overflow-hidden" style="width: 1270px; height: 705px;border-radius: 10px;">
                        <img src="../public/images/all.jpg" alt="Brand image" class="w-full h-full object-cover " />
                    </figure>
                </section>
            </div>
            ...
            <section style="margin-bottom:6.25rem;">
                <div class="flex items-center max-md:flex-col max-md:items-center  "style="margin-left: -80px;">

                    <img src="https://cdn.builder.io/api/v1/image/assets/fff8f95ab9b14906ad7fee76d4c8586f/2c965e66c4fc625573d8fcf9c38cdbd541277e7ff3e459222341cdec8b0752d4?placeholderIfAbsent=true"
                        alt="Workspace image" class="object-contain w-full  rounded-xl w-[499px]" style="height:584px" />

                    <div class=" w-full lg:min-w-[750px] text-xl font-normal leading-9 text-zinc-700 max-md:mt-10 max-md:max-w-full "
            ...
            <section class="flex justify-center">
                <div class="w-full lg:w-[80%] overflow-hidden rounded-lg shadow-lg" style="height: 500px;">
    ...
    <body class="font-['Lexend']">
        ...
        <!-- Brand Philosophy -->
        <section
            class="flex flex-col pt-1.5 pr-20 pb-5 w-full text-xl font-normal leading-9 text-zinc-700 max-md:pr-5 max-md:mt-10 max-md:px-6"
            style="margin-bottom:6.25rem;">
            <article class="self-start max-md:max-w-full">
...
<section style="margin-bottom:6.25rem;">
    <div class="flex items-center gap-10 max-md:flex-col max-md:items-center max-md:space-y-6">
        ...
        <!-- Google Maps -->
        <section class="flex justify-center">
            <div class="w-full lg:w-[80%] overflow-hidden rounded-lg shadow-lg max-md:w-full max-md:h-[400px]"
                style="height: 800px;">
