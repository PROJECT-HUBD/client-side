...
@section('main_content')
    <div class="w-full p-4 sm:p-6 bg-white rounded-lg shadow-sm">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-xl sm:text-2xl font-bold text-brandGray-normal">優惠券詳情</h1>
            <a href="{{ route('user.coupons') }}" class="px-3 py-1.5 sm:px-4 sm:py-2 border border-brandGray-lightActive text-brandGray-normal rounded-md hover:bg-brandGray-light focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brandGray-light">
                返回列表
            </a>
        </div>
        ...
        <div class="border border-brandGray-light rounded-lg overflow-hidden">
            ...
            <div class="p-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <h3 class="text-md font-medium text-brandGray-normal mb-2">優惠券資訊</h3>
                        <div class="space-y-3">
                            <div>
                                <p class="text-sm text-brandGray-normalLight">優惠說明</p>
                                <p class="text-brandGray-normal">{{ $coupon['description'] }}</p>
                            </div>
                            <div>
                                <p class="text-sm text-brandGray-normalLight">優惠碼</p>
                                <div class="flex items-center">
                                    <p class="text-brandGray-normal font-mono bg-brandGray-lightLight px-2 py-1 rounded mr-2">{{ $coupon['code'] }}</p>
                            ...
                            <div>
                                <p class="text-sm text-brandGray-normalLight">有效期限</p>
                                <p class="text-brandGray-normal">{{ $coupon['expiry_date'] }}</p>
                            </div>
                        </div>
                    </div>
                    <div>
                        <h3 class="text-md font-medium text-brandGray-normal mb-2">使用條款</h3>
                        <p class="text-brandGray-normal">{{ $coupon['terms'] }}</p>
                    </div>
                </div>
