...
>
  <section class="grow shrink min-w-60 w-[495px] max-md:max-w-full">
    <div class="w-full max-w-[607px] max-md:max-w-full">
      ...
      <address class="mt-4 w-full text-base text-zinc-500 max-md:max-w-full">
        <div
          class="flex flex-wrap gap-5 justify-between px-8 py-5 bg-white border border-solid border-zinc-500 max-md:px-5 max-md:max-w-full"
        >
          <div>
            台中市北區崇德路一段163號1樓
            <br />
          ...
          <img
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/236850f16d18b38d2294f5e699ca65b0d8ecef814bfc48602cab012590b73ccd?placeholderIfAbsent=true&apiKey=29bdb496da09449eb579968368248119"
            alt=""
            class="object-contain shrink-0 my-auto w-3 aspect-[1.5]"
          />
        </div>
      </address>
    </div>
    ...
    <section class="mt-12 max-w-full w-[607px] max-md:mt-10">
      ...
      <div class="mt-9 w-full max-w-[607px] max-md:max-w-full">
        <div
          class="flex flex-wrap gap-5 justify-between px-8 py-6 w-full bg-white border border-solid border-zinc-500 max-md:px-5 max-md:max-w-full"
        >
          <p class="text-base text-zinc-700">請選擇付款方式</p>
          <div class="flex gap-2 self-start">
            <img
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/fd1313b9d207b3de95049a9009c4b76ecda7a19270e54beaf929db321578b91c?placeholderIfAbsent=true&apiKey=29bdb496da09449eb579968368248119"
              alt="Payment method"
              class="object-contain shrink-0 aspect-[2] w-[50px]"
            />
            <img
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/236850f16d18b38d2294f5e699ca65b0d8ecef814bfc48602cab012590b73ccd?placeholderIfAbsent=true&apiKey=29bdb496da09449eb579968368248119"
              alt=""
              class="object-contain shrink-0 my-auto w-3 aspect-[1.5] fill-zinc-700"
            />
          </div>
        </div>
      </div>
    ...
    >
      ...
      >
        <div class="flex gap-6 items-center self-stretch my-auto min-w-60">
          <div
            class="flex shrink-0 self-stretch my-auto bg-zinc-700 h-[104px] w-[104px]"
          ></div>
