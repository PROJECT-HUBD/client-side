...
@section('content')
    <div class="mt-[120px]">
        ...
        <main class=" flex w-[1320px] mx-[60px] gap-10 max-md:flex-col max-md:items-center max-sm:p-5">
            <section class="flex gap-7 ml-[60px] max-sm:flex-col" aria-label="Product Gallery">
                ...
                <div class="relative w-[454px] max-sm:w-full">
                    <img id="mainProductImage"
                        ...
                        alt="Main product view" class="object-cover w-full rounded-md h-[580px]" loading="lazy" />
            ...
            <div class="w-[560px] h-[580px] mr-[60px] flex-col justify-start items-start gap-11 inline-flex">
                ...
                <div class="flex-col justify-start items-start gap-9 flex">
                    <div class="w-[257px] h-[50px] relative">
                        <div data-svg-wrapper class="left-[73px] top-0 absolute">
                            <svg width="183" height="52" viewBox="0 0 183 52" fill="none"
                    ...
                    <div class="justify-start items-center gap-[18px] inline-flex">
                        <div
                            class="w-[55px] text-center text-brandGray-normal text-2xl font-light font-['Lexend'] leading-9">
                            尺寸:</div>
                        <div
                            class="w-[50px] h-[50px]  py-[15px] bg-brandBlue-normal rounded-[5px] border border-brandBlue-normal flex-col justify-center items-center gap-2.5 inline-flex overflow-hidden">
                            <div class="text-center text-white text-2xl font-light font-['Lexend'] leading-9">L</div>
                        </div>
                        <div
                            class="w-[50px] h-[50px]  py-[15px] rounded-[5px] border border-brandBlue-normal flex-col justify-center items-center gap-2.5 inline-flex overflow-hidden">
                            <div class="text-center text-brandBlue-normal text-2xl font-light font-['Lexend'] leading-9">M
                            </div>
                        </div>
                        <div
                            class="w-[50px] h-[50px]  py-[15px] rounded-[5px] border border-brandBlue-normal flex-col justify-center items-center gap-2.5 inline-flex overflow-hidden">
                            <div class="text-center text-brandBlue-normal text-2xl font-light font-['Lexend'] leading-9">S
                            </div>
                        </div>
                    </div>
                </div>
                <div class="w-[330px] justify-start items-center gap-4 inline-flex">
                    <div class="justify-start items-center flex">
                        <div
                            class="w-[58px] p-2.5 rounded-tl rounded-bl border border-brandGray-lightHover flex-col justify-center items-center gap-2.5 inline-flex">
                            <div
                        ...
                        <div
                            class="w-[58px] p-2.5 rounded-tr rounded-br border border-brandGray-lightHover flex-col justify-center items-center gap-2.5 inline-flex">
                            <div
                                class="self-stretch text-center text-brandGray-normal text-[25.02px] font-medium font-['Poppins'] capitalize">
                                +</div>
                        </div>
                ...
                <div class="w-[558px] justify-start items-start gap-4 inline-flex">
                    <div
                        class="grow shrink basis-0 h-[58px] px-10 py-[15px] bg-brandBlue-normal rounded-[5px] flex-col justify-center items-center gap-2.5 inline-flex overflow-hidden">
                        <div class="text-center text-white text-2xl font-light font-['Lexend'] leading-9">加入購物車</div>
                    </div>
                    <div
                        class="grow shrink basis-0 h-[58px] px-10 py-[15px] bg-brandRed-normal rounded-[5px] flex-col justify-center items-center gap-2.5 inline-flex overflow-hidden">
            ...
            <div class="h-[546px] w-[1320px] mx-[60px] flex-col justify-start items-center gap-5 inline-flex mt-[100px]">
                <div class="h-[54px] border-b border-brandGray-lightHover justify-center items-start gap-10 inline-flex">
                    <div
                        class="px-4 py-3  shadow-[inset_0px_-3px_0px_0px_rgba(220,53,69,1.00)] justify-start items-start gap-2 flex">
                        <div class="text-brandRed-normal text-xl font-light font-['Lexend'] leading-[30px]">產品須知</div>
                    </div>
                    <div class="px-4 py-3  justify-start items-start gap-2 flex">
                        <div class="text-brandGray-normal text-xl font-light font-['Lexend'] leading-[30px]">產品展示圖</div>
                    </div>
                </div>
                <div class="w-full">
                ...
                <div
                    class="self-stretch  px-[180px] pt-10 pb-[60px] bg-brandGray-light flex-col justify-start items-start flex ">
                    ...
                    <div class="w-[928px] h-[93px] relative  overflow-hidden">
                        <div
                            ...
                            <div
                                class="w-[33px] h-[19px] text-center text-white text-sm font-light font-['Lexend'] leading-snug">
                                材質
                            </div>
                        </div>
                        <div
            ...
            <script>
                $(document).ready(function () {
                    $("#likeBtn").click(function () {
                        $("#likeIcon").toggleClass("text-brandRed-normal fill-brandRed-normal text-brandGray-normal fill-brandGray-normal")
                    })
