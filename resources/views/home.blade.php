...
<div class="mt-[60px]">
    <!-- banner 輪播圖 -->
    <section class="max-w-full h-[736px] border-b-2 shadow-[0_15px_0_0_brandGray-normalLight] flex flex-col">
        <div class="relative w-full h-[600px] overflow-hidden flex justify-center items-start mb-10">
            <!-- 左側圖片 -->
            <div class="absolute left-[-400px] w-[720px] h-[600px]" style="margin-right: 20px;">
                <img src="{{ asset('images/home_test1.JPG') }}" alt="" class="w-full h-full object-cover">
            </div>
            <!-- 中間圖片 -->
            <div class="relative w-[720px] h-[600px] z-10">
                <img src="{{ asset('images/home_test2.JPG') }}" alt="" class="w-full h-full object-cover">
            </div>
            <!-- 右側圖片 -->
            <div class="absolute right-[-400px] w-[720px] h-[600px]" style="margin-left: 20px;">
                <img src="{{ asset('images/home_test3.JPG') }}" alt="" class="w-full h-full object-cover">
            </div>
        </div>

        <!-- progress + btn -->
        <div class="w-full h-[50px] flex justify-senter items-center px-[100px]">
            ...
            <div class="w-[600px] h-[920px] flex flex-col justify-center items-center gap-5">
                ...
                <div class="w-full h-[266px]">
                    ...
                    <div class="flex justify-start items-center gap-5">
                        ...
                        <button type="button" class="w-[300px] h-[58px] text-[24px] text-semibold text-brandGray-lightLight flex justify-center items-center bg-brandRed-normal rounded-md">直接購買<span class="w-[24px] h-[24px] text-brandGray-lightLight icon-[ep--arrow-right-bold]"></span></button>
                    </div>
                </div>
            </div>
        </div>
